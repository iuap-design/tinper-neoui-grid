// 后续和createSumRow整合
const createContentGroupSumRow = function(groupRow, createFlag) {
...
const createContentGroupSumRowTd = function(groupRow, createFlag) {
    var htmlStr = '',
        oThis = this,
        gridCompColumnArr;
    if (createFlag == 'fixed') {
...
const repairGroupSumRow = function(rowObj) {
    if (this.options.groupSumRow) {
        var oThis = this,
        ...
        if (this.re_repairGroupSumRowSetTimeout)
            clearTimeout(this.re_repairGroupSumRowSetTimeout)
...
const repairGroupSumRowFun = function() {
    var oThis = this;
...
export const groupSumRowFunObj = {
