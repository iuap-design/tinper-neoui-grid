(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', './gridCompEvent'], factory);
    ...
    // };
    // 行拖拽开始之前
    const rowDragStart = function (e, ele) {
        var oThis = this;
        // 保存element，
        // 记录之前clientx，clienty
        // 记录当前行的序号
    ...
    const rowDragFunObj = exports.rowDragFunObj = {
